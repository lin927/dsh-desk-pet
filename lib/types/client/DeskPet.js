...
import { PET_ASSETS } from "./assets.js";
...
export function DeskPet(props) {
    ...
    React.useEffect(() => {
        const t1 = window.setTimeout(() => { if (!celebrating.current)
            setAction('idle'); }, 2000);
    ...
    function scheduleAmbient() {
        if (ambientTimer.current !== null || celebrating.current)
            return;
    ...
    return React.createElement('div', { style: rootStyle(pos, dragging), onPointerDown: onPointerDown }, bubble === null
        ? null
        : React.createElement('div', { style: bubbleStyle }, bubble), React.createElement('img', {
        style: imgStyle,
        src,
        alt: '桌宠',
        title: '怪盗基德桌宠',
